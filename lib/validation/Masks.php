...
class Masks{
    ...
    'registMask' => [
        ...
        'UpdateStructureObjectCheckMask'=>[
            'node_id' => [
                'func' => 'Md5Type',
                'props' => [],
                'required' => true],
    ...
    'addModelMask'=>[
        ...
        'updateModelSpecsCheckMask'=>[
            ...
            'field_names' => [
                'func'=>'multiple',
                'props'=>['func'=>'Text','except'=>'\*\;\=\@','min'=>1,'max'=>255],
                'required' => false],
            'field_values' => [
                'func'=>'multiple',
                'props'=>['func'=>'Text','except'=>'\*\;\=\@','min'=>1,'max'=>255],
    ...
    'getModelsMask'=>[
        ...
        'comparison' => [
            'func'=>'multiple',
            'props'=>['func'=>'ValueFromList', 'list'=>['LIKE','<','>']],
            'required' => false],
        'output' => [
            'func'=>'ValueFromList',
            'props'=>['list'=>['page','json']],
            'required' => false],
    ],
