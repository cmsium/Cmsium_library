...
namespace Lib\Headers;
     ...
     */
    function respondContentType($params) {
     ...
     * @return bool Всегда возвращает true
     */
    function respondLocation($params) {
     ...
     * @return bool Всегда возвращает true
     */
    function respondContentMD5($params) {
     ...
     * @return bool Всегда возвращает true
     */
    function respondContentLocation($params) {
     ...
     * @return bool Всегда возвращает true
     */
    function respondContentDisposition($params) {
     ...
     * @return bool Всегда возвращает true
     */
    function respondContentRange($params) {
     ...
     * @return bool Всегда возвращает true
     */
    function respondContentLength($params) {
     ...
     * @return bool Всегда возвращает true
     */
    function respondCacheControl($params = ['value' => ['max-age=3600', 'must-revalidate']]) {
     ...
     * @return bool Всегда возвращает true
     */
    function respondAcceptLanguage($params) {
     ...
     * @return bool Всегда возвращает true
     */
    function respondAllow($params = ['value' => ['GET', 'POST', 'PUT']]) {
     ...
     * @return bool Всегда возвращает true
     */
    function respondAcceptRanges($params = ['value' => 'range-unit']) {
     ...
     * @return bool Всегда возвращает true
     */
    function respondAcceptEncoding($params = ['value' => ['gzip','deflate']]) {
     ...
     * @return bool Всегда возвращает true
     */
    function respondAcceptCharset($params = ['value' => 'utf-8']) {
     ...
     * @return bool Всегда возвращает true
     */
    function responseAccept($params = ['value' => 'text/plain']) {
     ...
     * @return bool Результат работы функции
     */
    function respondJSON($params = ['filename' => "json_api.json"]) {
     ...
     * @return bool Всегда возвращает true
     */
    function respondNoCache($params) {
     ...
     * @return bool Всегда возвращает true
     */
    function respondCache($params = ['offset' => 3600]) {
        $time = \gmdate("D, d M Y H:i:s \G\M\T");
        $time_expires = \gmdate("D, d M Y H:i:s \G\M\T", \time() + $params['offset']);
